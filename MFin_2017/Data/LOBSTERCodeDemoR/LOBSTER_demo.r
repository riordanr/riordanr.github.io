...
# Load data
dataM <- read.csv ("/Users/ryanriordan/Dropbox (School of Business)/Teaching/Queens/Winter2017/FinTech_MFin/Data/LOBSTERCodeDemoR/AMZN_2012-06-21_34200000_57600000_message_10.csv")   
...
# Load data
dataOB <- read.csv("/Users/ryanriordan/Dropbox (School of Business)/Teaching/Queens/Winter2017/FinTech_MFin/Data/LOBSTERCodeDemoR/AMZN_2012-06-21_34200000_57600000_orderbook_10.csv")  
...
# Title 
title(sprintf("Limit Order Book Volume" ,ticker,dataM_part[random_no,1]) , cex = 0.8)
...
# Title 
title(sprintf("Relative Depth in the LOB" ,ticker,dataM_part[random_no,1] , nlevels) , cex = 0.8 )
